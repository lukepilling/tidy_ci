...
#fit_logistic |> tidy_ci()   # detect model and exponentiate automatically
#fit_logistic |> tidy_ci(check_family=FALSE)  # override auto checking to get untransformed estimates
